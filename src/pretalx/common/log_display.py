...
LOG_NAMES = {
    ...
    "pretalx.submission.change_request.create": _("A change request was submitted."),
    "pretalx.submission.change_request.update": _("A change request was updated."),
    "pretalx.submission.change_request.accept": _("A change request was accepted."),
    "pretalx.submission.change_request.reject": _("A change request was rejected."),

...
LOG_NAMES = {
    ...
    "pretalx.submission.speaker_profiles.add": _("A speaker was added to the proposal."),
    "pretalx.submission.speaker_profiles.invite": _("A speaker was invited to the proposal."),
    "pretalx.submission.speaker_profiles.remove": _("A speaker was removed from the proposal."),
